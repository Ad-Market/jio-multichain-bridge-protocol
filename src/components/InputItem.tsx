            ...
            <div className={"w-80 max-w-xs"}>
                <div className={"space-y-1"}>
                    ...
                    <div className="relative">
                        <span className="inline-block w-80 border-b-4 border-white-500 h-14 text-left">
                            {/* <input type="number" value={`${amount}`} onChange={onChange} /> */}
                            <input className="bg-transparent w-80" type="number" value={selectedItem?.label || ""} onChange={e => setSelectedItem(e.target.value)} />
                        </span>
                    </div>
                </div>
